<?php
// views/admin/BookingCustomer/create.php
...
<div class="container mt-4">
    ...
    <!-- Form -->
    <form action="index.php?act=admin-booking-customer-store" 
          method="POST" 
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <select name="customer_type" class="form-select form-select-lg" required>
                    ...
                    <option value="ADULT" <?= ($old['customer_type'] ?? '') === 'ADULT' ? 'selected' : '' ?>>
            ...
            <div class="mb-3">
                ...
                <input type="text" 
                       ...
                       value="<?= htmlspecialchars($old['nationality'] ?? 'Việt Nam') ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="notes" 
                          class="form-control" 
                          rows="3"
                          placeholder="VD: Dị ứng hải sản, ăn chay, cần hỗ trợ di chuyển..."><?= htmlspecialchars($old['notes'] ?? '') ?></textarea>
                <small class="text-muted">
                    <i class="bi bi-info-circle"></i> 
                    Thông tin về sức khỏe, chế độ ăn uống, yêu cầu đặc biệt...
                </small>
            </div>
        ...
        <div class="card-footer bg-light">
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="bi bi-save"></i> Lưu khách
                </button>
                <a href="index.php?act=admin-booking-customer&booking_id=<?= $booking['id'] ?>" 
