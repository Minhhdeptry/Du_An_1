    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <?php if (!empty($_SESSION['role']) && $_SESSION['role'] === 'HDV'): ?>
                            <li class="breadcrumb-item"><a href="?act=admin-staff-assigned-tours">Tour được phân công</a></li>
                        <?php else: ?>
            ...
            <div class="btn-group">
                ...
                <?php endif; ?>
                <a href="?act=<?= (!empty($_SESSION['role']) && $_SESSION['role'] === 'HDV') ? 'admin-staff-assigned-tours' : 'admin-tour' ?>" class="btn btn-secondary action-btn">
